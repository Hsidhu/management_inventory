...
class TransactionController extends Controller
{
    ...
    public function type($type)
    {
        switch ($type) {
            case 'item_received':
                return view('transactions.expense.index', ['transactions' => Transaction::where('type', 'item_received')->latest()->paginate(25)]);
            case 'item_sold':
                return view('transactions.income.index', ['transactions' => Transaction::where('type', 'item_sold')->latest()->paginate(25)]);
        }
    }
